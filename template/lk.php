...
<h1 class="page-header"><i class="fa fa-user"></i> Личный кабинет</h1>
<div class="row placeholder">
    ...
    <div class="col-lg-3 col-xs-6">
        <div class="info-box bg-red">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Входящие заявки</span>
                <span class="info-box-number"><?= $row_vhod["count"] ?></span>
                <!-- The progress section is optional -->
                <div class="progress">
                    <div class="progress-bar" style="width: 100%"></div>
                </div>
                <span class="progress-description">
                    <a href="?act=in" class="small-box-footer" style="color: white; text-decoration: none;">
    ...
    <div class="col-lg-3 col-xs-6">
        <div class="info-box bg-yellow">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Взято в работу</span>
                <span class="info-box-number"><?= $row_to_do["count"] ?></span>
                <!-- The progress section is optional -->
                <div class="progress">
                    <div class="progress-bar" style="width: 100%"></div>
                </div>
    ...
    <div class="col-lg-3 col-xs-6">
        <div class="info-box bg-aqua">
            ...
            <div class="info-box-content">
                <span class="info-box-text"> исходящие заявки</span>
                <span class="info-box-number"><?= $row_ishod["count"] ?></span>
                <!-- The progress section is optional -->
                <div class="progress">
                    <div class="progress-bar" style="width: 100%"></div>
                </div>
                <span class="progress-description">
                    <a href="?act=out" class="small-box-footer" style="color: white; text-decoration: none;">
                        Перейти <i class="fa fa-arrow-circle-right"></i>
                    </a>
                </span>
            </div><!-- /.info-box-content -->
    ...
    <div class="col-lg-3 col-xs-6">
        <div class="info-box bg-green">
            ...
            <div class="info-box-content">
                <span class="info-box-text"> выполненые заявки</span>
                <span class="info-box-number"><?= $row_done["count"] ?></span>
                <!-- The progress section is optional -->
                <div class="progress">
                    <div class="progress-bar" style="width: 100%"></div>
                </div>
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="box box-success">
            <div class="box-header">
                <h3 class="box-title"><a href="?act=news"><i class="fa fa-bullhorn"></i> Последнии новости</a></h3>
            </div>
            <div class="box-body">
                        ...
                        <?php while ($row = $result->fetch_assoc()) : ?>
                            ...
                            <tr>
                                <td><small><i class="fa fa-file-text-o"></i></small>
                                    <a href="?act=show_news&id=<?= $row["id"] ?>"><small><?php if (mb_strlen($row["msg"]) > 100) {
                                                                                                $row["msg"] = mb_substr($row["msg"], 0, 97) . '...';
                                                                                            }
                                ...
                                <td class="text-right">
                                    <small><?php setlocale(LC_ALL, 'ru_RU.UTF8');
                                            echo strftime("%a, %e %B %Y %H:%M:%S", strtotime($row["date_create"])); ?>
                                    </small>
                                </td>
                            </tr>
                        <?php endwhile; ?>
    ...
    <div class="col-md-12">
        <div class="box box-success">
            <div class="box-header">
                <h3 class="box-title"><i class="fa fa-list-alt"></i> Последнии заявки</h3>
                <div class="box-tools">
                        ...
                        <table class="table table-bordered table-hover " style=" font-size: 14px;">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        <center>От кого</center>
                                    </th>
                                    <th>
                                        <center>Создана</center>
                                    </th>
                                    <th>
                                        <center>Прошло</center>
                                    </th>
                                    <th>
                                        <center>Автор</center>
                                    </th>
                                ...
                                <form role="form" id="Form">
                                    <?php while ($row = $result->fetch_assoc()) : ?>
                                        ...
                                        endswitch ?>
                                            ...
                                            <td style=" vertical-align: middle; "><small class=""><?php if (mb_strlen($row["msg"]) > 30) {
                                                                                                        $row["msg"] = mb_substr($row["msg"], 0, 27) . '...';
                                                                                                    }
                                                                                                    $row["msg"] = nl2br($row["msg"]);
                                                                                                    echo $row["msg"]; ?></small></td>

                                            <td style=" vertical-align: middle; "><small class="">
                                                    <center><?= $row["client"] ?></center>
                                                </small></td>

                                            <td style=" vertical-align: middle; "><small class="">
                                                    <center><?php setlocale(LC_ALL, 'ru_RU.UTF8');
                                                            echo strftime("%a, %e %B %Y %H:%M:%S", strtotime($row["date_create"])); ?></center>
                                                </small></td>
