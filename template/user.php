                        ...
                        <form role="form" id="UserForm">
                            <?php while ($row = $result->fetch_assoc()) : ?>
                                <tr>
                                    ...
                                    <td style=" vertical-align: middle; "><small class="">
                                            <center><?= $row["login"] ?></center>
                                        </small>
                                    </td>

                                    <td style=" vertical-align: middle; "><small class="">
                                            <center><?= $row["fio"] ?></center>
                                        </small>
                                    </td>

                                    <td style=" vertical-align: middle; "><small class="">
                                            <center><?php if ($row["status"] == 0) echo "отключён";
                                                    if ($row["status"] == 1) echo "включён"; ?></center>
                                        </small>
                                    </td>

                                    <td style=" vertical-align: middle; "><small class="">
                                            <center><?php if ($row["priv"] == 0) echo "администратор";
                                                    if ($row["priv"] == 1) echo "координатор";
                                                    if ($row["priv"] == 2) echo "исполнитель"; ?></center>
                                        </small>
                                    </td>
                                    ...
                                    <td style=" vertical-align: middle; "><small class="">
                                            <center><?php setlocale(LC_ALL, 'ru_RU.UTF8');
                                                    echo strftime("%a, %e %B %Y %H:%M:%S", strtotime($row["last_time"])); ?></center>
                                        </small>
                                    </td>
