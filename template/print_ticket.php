...
<head>
    ...
    <link rel="stylesheet" href="/js/bootstrap/css/bootstrap.min.css?2.95">
    <link rel="stylesheet" href="/css/jquery-ui.min.css?2.95">
    <link rel="stylesheet" href="/css/ionicons.min.css?2.95">
    <link rel="stylesheet" href="/css/style.css?2.95">
    <link rel="stylesheet" href="/css/font-awesome/css/font-awesome.min.css?2.95">
    <link rel="stylesheet" href="/css/chosen.min.css?2.95">
    <style type="text/css" media="all">
        .chosen-rtl .chosen-drop {
            left: -9000px;
        }
    </style>
    <link rel="stylesheet" href="/css/print.css?2.95">
    <link rel="stylesheet" href="/css/AdminLTE.css?2.95">
    <link rel="stylesheet" href="/css/skin-blue.css?2.95">
</head>
        ...
        <div class="row">
            <div class="col-xs-12">
                <h2 class="page-header">
                    Система заявок <small class="pull-right"><?= date("d.m.Y") ?></small>
                </h2>
            </div><!-- /.col -->
        </div>
        <!-- info row -->
        <div class="row invoice-info">
            ...
            <div class="col-sm-4 invoice-col">
                ...
                <address>
                    ...
                    <i class="fa fa-envelope-o"></i> <?= $row3["email"] ?>
                </address>
            </div><!-- /.col -->
        </div><!-- /.row -->
