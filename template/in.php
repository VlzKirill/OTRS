 ...
 */
                ...
                <div class="btn-group btn-group-justified">
                    <a class="btn btn-default btn-sm btn-flat active " role="button" href="?act=in"><i class="fa fa-download"></i> Входящие
                        <span id="label_list_in">(<?= $row_vhod["count"] ?>) </span>
                    </a>

                    <a class="btn btn-default btn-sm btn-flat " role="button" id="link_out" href="?act=out"><i class="fa fa-upload"></i> Исходящие
